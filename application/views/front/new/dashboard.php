                            ...
                            <div class="owl-stage" style="transform: translate3d(-1200px, 0px, 0px); transition: all 0s ease 0s; width: 4600px;">
                                ...
                                <div class="owl-item" style="width: 170px; margin-right: 30px;">
                                    <div class="item">
                                        <a href="#" class="category-item">
                                            <div class="cate-img">
                                                <img src="https://gambolthemes.net/html-items/gambo_supermarket_demo/images/category/icon-10.svg" alt="">
                                            </div>
                                            <h4> Meat &amp; Seafood </h4>
                                        </a>
                                    </div>
                                ...
                                <div class="owl-item" style="width: 170px; margin-right: 30px;">
                                    <div class="item">
                                        <a href="#" class="category-item">
                                            <div class="cate-img">
                                                <img src="https://gambolthemes.net/html-items/gambo_supermarket_demo/images/category/icon-11.svg" alt="">
                                            </div>
                                            <h4> Electronics </h4>
                                        </a>
                                    </div>
                            ...
                            <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 2360px;">
                                    ...
                                    <div class="item">
                                        <div class="product-item">
                                            <a href="https://gambolthemes.net/html-items/gambo_supermarket_demo/single_product_view.html" class="product-img">
                                                <img src="https://gambolthemes.net/html-items/gambo_supermarket_demo/images/product/img-1.jpg" alt="">
                                ...
                                <div class="owl-item" style="width: 285px; margin-right: 10px;">
                                    <div class="item">
                                        <div class="product-item">
                                            <a href="https://gambolthemes.net/html-items/gambo_supermarket_demo/single_product_view.html" class="product-img">
                                                <img src="https://gambolthemes.net/html-items/gambo_supermarket_demo/images/product/img-8.jpg" alt="">
                                                <div class="product-absolute-options">
