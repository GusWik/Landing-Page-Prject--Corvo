        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="#">
                ...
                <span class="logo-text">
                     <!-- dark Logo text -->
                     <h3 class="text-white" style="margin-top: 10px; margin-left: 15px">Bako Mart</h3>
                     <!-- <img src="<?php echo base_url()?>/assets/images/logo-text.png" alt="cloudaron" class="light-logo" /> -->
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated">
                        ...
                        <div class="dropdown-divider"></div> -->
                        <a class="dropdown-item" href="<?= base_url('login/log');?>"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                        <!-- <div class="dropdown-divider"></div>
