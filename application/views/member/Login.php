            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db">
                            <h3 class="text-white">RANCANG BANGUN E-COMMERCE PADA BAKO - MART MENGGUNAKAN METODE AGILE DEVELOPMENT</h3>
                    ...
                    <form class="form-horizontal m-t-20" id="loginform" action="<?php echo base_url('login/doLogin/'); ?>" method="post">
